...
class ViewProfile(LoginRequiredMixin, ListView):
    model = Post
    template_name = 'insta/user_profile.html'
...
class CreateComment(LoginRequiredMixin, CreateView):
    ...
    def get_success_url(self, **kwargs):
        ...
        return reverse('insta-detail', args={pk: 'pk'})
...
class ViewLikes(LoginRequiredMixin, ListView):
    model = Post
    template_name = 'insta/post_likes.html'
...
class ViewNotifications(LoginRequiredMixin, ListView):
    model = Notification
    template_name = 'insta/notifications.html'
